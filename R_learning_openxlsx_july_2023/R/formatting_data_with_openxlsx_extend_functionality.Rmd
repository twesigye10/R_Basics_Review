...
writeDataTable(wb = wb_format, sheet = "writeDataTable", x = df_to_format, startRow = 4, startCol = 2, tableStyle = "TableStyleLight9", headerStyle = hs1_formatting)

# openXL(wb_format) ## opens a temp version

saveWorkbook(wb_format, "outputs/testing_openxls_v2.xlsx", overwrite = TRUE)
```
